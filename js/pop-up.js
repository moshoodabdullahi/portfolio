...
const details = [
  {
    ...
    description:
      'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry standard dummy text ever since the 1500s, when an unknown printer took a challery of type and scrambled it to make a type specimen book. It has survived not only five centuries..',
    links: ['html', 'css', 'javascript'],
  },
  {
...
const generateDetailsWork = (title, tags, screenshot, screenshotalt, description, links) =>
  `<article id="display-tonic-element" class="details-target-element details-works-article details-popup left d-none">
<div class="works-article d-flex">
  <div class="details-header">
    <h3 class="works-headline details-works-headline">
      ${title}
      <svg id="close-tonic-element" class="close-details" width="30" height="30" viewBox="0 0 25 29" fill="none"
