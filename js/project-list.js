const projects = [
  {
    ...
    description: `An Admin Dashboard Project, it is a personalized project; it is also not linked to any accounts rather it is a project to test qualification.`,
    fullDescription: `In the Admin Dashboard project full description there is a well explained site called The Odin Project where all the requirement for the project is seen and followed to achieve the project. A good UI design that is responsive and also test the qualification of a students that is wants to become a software engineer.
  ...
  },
  {
    ...
    description:
      'Basketball Scoreboard project is an HTML, CSS and JavaScript Project, it is use to test the JavaScript knowledge of a student in an early stage.',
    fullDescription: `Basketball Scoreboard project is an HTML, CSS and JavaScript Project, it is use to test the JavaScript knowledge of a person learning to become a software developer, we make use of querySelector; it is know for getting an Id from the HTML file.
  ...
  },
  {
    ...
    description:
      'The City Skyline project is an FCC(FreeCodeCamp) project that focuses on enhancing CSS(Cascading Style Sheet) skill.',
    fullDescription: `The City Skyline project is an FCC(FreeCodeCamp) project that focuses on enhancing CSS(Cascading Style Sheet) skill.
  ...
  },
  {
    ...
    description:
      'The Random Password generator project focuses more on enhancing the JS skill of a learner.',
    fullDescription: `The Random Password generator project focuses more on enhancing the JS skill of a learner, we make use of JavaScript Array, querySelector and so on to make the button clickable and for it to perform an advance work of showing up 15 digits of passwords when clicked.
